...
INSERT IGNORE INTO `servicios` (`id_servicio`, `nombre_servicio`, `descripcion_servicio`, `imagen_servicio`, `valor_servicio`, `link_contacto`) VALUES
...
INSERT IGNORE INTO `usuarios` (`id_usuario`, `nombre_usu`, `apellido_usu`, `tel_usu`, `correo_usu`, `usu_usu`, `pwd_usu`) VALUES
